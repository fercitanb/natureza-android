...
import static com.mariafernandanb.natureza.util.Constantes._URL_CANCELAR_PEDIDO;

/**
 * Created by gonzalopro on 12/12/16.
 */

public class CancelarPedido extends AsyncTask<Void,Void,Void> {
    ...
    public CancelarPedido(String idPedido, String motivo) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            url = new URL(_URL_CANCELAR_PEDIDO);
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("motivo", motivo);
