...
public class SessionCliente extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                ...
                startActivity(new Intent(getApplicationContext(),registroDireccion.class));
            }
        });
        ...
        tvNombre = (TextView)vw.findViewById(R.id.nombreCliente);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.session_cliente, menu);
        return true;
    }
